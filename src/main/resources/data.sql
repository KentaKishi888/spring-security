insert into issues (summary, description) values ('TEST1', 'there is bugs');
insert into issues (summary, description) values ('TEST2', 'hello world');
insert into issues (summary, description) values ('TEST3', 'java is so easy');
